...
-make sure that node version is >=18

-create index from the side of Pinecone and use the same name from the side of the app

-add a paymenth method to open.ai https://platform.openai.com/account/usage
